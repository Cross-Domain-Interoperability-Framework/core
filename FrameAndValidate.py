#!/usr/bin/env python3
"""
CDIF Core JSON-LD Framing and Validation Script
...
def main():
    parser = argparse.ArgumentParser(
        description='CDIF Core JSON-LD Framing and Validation Tool',
...
Examples:
  ...
  # Validate against CDIF Core schema
  python FrameAndValidate.py my-metadata.jsonld --frame cdifCore-frame.jsonld -v --schema cdifCoreStructuredSchema.json

  # Full workflow with local files
  python FrameAndValidate.py my-metadata.jsonld --frame cdifCore-frame.jsonld -o framed.json -v --schema cdifCoreStructuredSchema.json
"""
    )
    ...
    parser.add_argument('--schema', default=str(SCRIPT_DIR / 'cdifCoreStructuredSchema.json'),
                        help='Path to JSON Schema (default: cdifCoreStructuredSchema.json)')
    parser.add_argument('--frame', default=str(SCRIPT_DIR / 'cdifCore-frame.jsonld'),
                        help='Path to JSON-LD frame (default: cdifCore-frame.jsonld)')
